...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-[1200px] px-2 md:px-3">
      {toastText && (
      ...
      <section className="ink-panel p-5 md:px-9 md:py-8">
        <header className="mb-4 flex items-baseline justify-between gap-3">
          <div>
            <h2 className="font-ritual-title text-base font-semibold tracking-[0.08em] text-[#34281f] md:text-lg">
              问卦者
            </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <input
                ...
                placeholder="如：1993"
                className="w-full border-b border-dashed border-[#d7c3a7] bg-transparent px-0 pb-1 text-sm text-[#3e3127] outline-none transition-colors focus:border-solid focus:border-[#B08A57]"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-xs text-[#4a3a2a] md:text-sm">
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-full border px-3 py-1 text-[11px] ${
                        selected
                          ? "border-[#b08a57] bg-[#efe0c4] text-[#4b3423] shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]"
                          : "border-[#d8c7a6] bg-[#fffaf2]/40 text-[#5c4a38] hover:bg-[#f5efe4]"
                      }`}
                    >
                      {opt.label}
                    </button>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              placeholder={"将心中所问写下\n一事一念，卦自有应"}
              className="ink-input min-h-[112px] resize-none"
            />
          ...
          <div className="pt-2">
            <button
              type="submit"
              className={`ink-button-primary w-full gap-2 md:text-base ${
                canSubmit
                  ? ""
